  ...
  <div class="login_container">    
    <el-form class="login_form" :rules="rules" :model="loginForm" ref="loginElFrom">
      ...
      <el-form-item prop="number">
        <el-input :prefix-icon="User" v-model="loginForm.number">
        </el-input>
      </el-form-item>
      <el-form-item prop="password">
        <el-input :prefix-icon="Lock" type="password" 
        show-password="true" v-model="loginForm.password">
        </el-input>
      </el-form-item>
      <el-form-item>
        <el-button class="login_button" type="primary" 
        @click="login" :loading="loading" size="default">
          登录
        </el-button>
      </el-form-item>
    </el-form>
